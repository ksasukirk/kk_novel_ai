# Fill this turn's length

This turn has already written {{have_chars}} characters. The required length is at least {{min_chars}} characters (exceeding is allowed). About {{need_chars}} characters are still needed.
...
Already written prose (continue from the end):
{{draft}}
