...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project_content_substance,
            commands::project_apply_title,
            commands::chapter_read,
            commands::chapters_peek_batch,
            commands::chapter_io_debug_stats,
            commands::chapter_io_debug_reset,
